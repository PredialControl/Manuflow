          ...
          <div className="h-16 w-16 bg-primary shadow-2xl shadow-primary/40 rounded-[1.25rem] flex items-center justify-center overflow-hidden">
            <img
              ...
              onError={(e) => {
                ...
                if (p) p.innerHTML = '<span class="text-white text-3xl font-black italic">M</span>';
              }}
            />
          </div>
          ...
          <CardContent className="p-8 pt-10">
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <Label
                  htmlFor="email"
                  className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/80 ml-1"
                >
                  E-mail Corporativo
                </Label>
                <Input
              ...
              <div className="flex items-center gap-2.5 px-1">
                <Checkbox id="remember" defaultChecked className="rounded-md" />
                <Label
                  htmlFor="remember"
              ...
              <Button
                type="submit"
                className="w-full h-12 rounded-xl font-black text-xs uppercase tracking-widest shadow-lg shadow-primary/20 transition-all hover:scale-[1.01] active:scale-[0.99] mt-2"
                disabled={loading}
              >
